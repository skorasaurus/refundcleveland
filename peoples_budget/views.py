...
def home(request):
    with open(os.path.join(settings.BASE_DIR, 'static/data/2026-mayors-estimate-fullgeneralfund.json')) as file:
...
def send_email(submitter_email, id):
    return requests.post(
        ...
        data={"from": "Refund Cleveland <info@refundcleveland.com>",
              ...
              "text": f"Thank you for submitting your budget proposal for the 2026 City of Cleveland Budget!\n"
